...
-- If I want to use powershell as my shell in the neovim terminal I uncomment the following lines.
-- local powershell_options = {
--   shell = vim.fn.executable("pwsh") == 1 and "C:/Users/ARK010/Documents/Powershell/pwsh.exe" or "powershell",
